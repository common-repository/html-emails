<table width="100%" style="padding: 10px;">
	<tr>
		<td>
			...
			<p><?php _e( 'To activate your blog, please click on the link below. After you activate, you will receive *another email* with your login. You can visit your site after activation.', 'html-emails' ); ?></p>
